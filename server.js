...
cloudinary.config({
  cloud_name: "monarch360",
  api_key: "526292899455724",
  api_secret: "3us4IsRUTLNR8raKV9ziUf44pY0",
  secure: true,
});
...
app.use(
  clientSessions({
    cookieName: "session", // this is where the object name that will be added to 'req'
...
app.get("/blog", async (req, res) => {
  // Declaration of an object to store properties for the view
  let viewData = {};

  try {
    // declaration of empty array to hold "post" objects
    let posts = [];
